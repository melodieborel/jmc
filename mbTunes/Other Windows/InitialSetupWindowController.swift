...
class InitialSetupWindowController: NSWindowController {
    ...
    func setupForNilLibrary() { //does not handle errors good
        ...
        do {
            ...
            let mbTunesDirURL = userMusicDirURL.appendingPathComponent("mbTunes", isDirectory: true)
            try FileManager.default.createDirectory(atPath: mbTunesDirURL.path, withIntermediateDirectories: true, attributes: nil)
