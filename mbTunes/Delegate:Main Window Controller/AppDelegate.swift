...
class AppDelegate: NSObject, NSApplicationDelegate, NSMenuDelegate {
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        ...
        let mediaKeyListenerQueue = DispatchQueue(label: "com.melodieborel.mbTunes.media-key-listener", qos: .default, attributes: [], autoreleaseFrequency: .inherit, target: nil)
    ...
    lazy var applicationDocumentsDirectory: URL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "melodieborel.mbTunes" in the user's Application Support directory.
        let urls = FileManager.default.urls(for: .applicationSupportDirectory, in: .userDomainMask)
        let appSupportURL = urls[urls.count - 1]
        return appSupportURL.appendingPathComponent("melodieborel.mbTunes")
    }()

    lazy var managedObjectModel: NSManagedObjectModel = {
        // The managed object model for the application. This property is not optional. It is a fatal error for the application not to be able to find and load its model.
        let modelURL = Bundle.main.url(forResource: "mbTunes", withExtension: "momd")!
    ...
    lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        if failError == nil {
            ...
            let url = self.applicationDocumentsDirectory.appendingPathComponent("mbTunes.db")
            do {
